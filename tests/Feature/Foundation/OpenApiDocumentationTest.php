...
class OpenApiDocumentationTest extends TestCase
{
    public function test_openapi_document_includes_current_catalog_and_admin_routes(): void
    {
        ...
        $this->assertContains('/customer/stores', $paths);
        $this->assertContains('/customer/stores/{store}', $paths);
        $this->assertContains('/customer/stores/{store}/products', $paths);
        $this->assertContains('/customer/products/{product}', $paths);
        $this->assertContains('/customer/stores/{store}/delivery-options', $paths);
        $this->assertContains('/customer/stores/{store}/time-slots', $paths);
        $this->assertContains('/customer/stores/{store}/cart-data', $paths);
        $this->assertContains('/customer/stores/{store}/coupons', $paths);
        $this->assertContains('/customer/coupons/check', $paths);
        ...
        $this->assertContains('/customer/payment-methods', $paths);
        $this->assertContains('/customer/wallet-transactions', $paths);
        $this->assertContains('/customer/wallet/top-ups', $paths);
        $this->assertContains('/customer/orders', $paths);
        $this->assertContains('/customer/orders/{order}', $paths);
        $this->assertContains('/customer/orders/{order}/rating', $paths);
        $this->assertContains('/customer/subscription-orders', $paths);
        $this->assertContains('/customer/subscription-orders/{subscriptionOrder}', $paths);
        $this->assertContains('/customer/subscription-orders/{subscriptionOrder}/rating', $paths);
        $this->assertContains('/customer/subscription-orders/{subscriptionOrder}/items/{item}/skip', $paths);
        $this->assertContains('/customer/subscription-orders/{subscriptionOrder}/items/{item}/extend', $paths);
        $this->assertContains('/store/dashboard', $paths);
        $this->assertContains('/store/categories', $paths);
        $this->assertContains('/store/categories/{category}', $paths);
        $this->assertContains('/store/coupons', $paths);
        $this->assertContains('/store/coupons/{coupon}', $paths);
        $this->assertContains('/store/delivery-options', $paths);
        $this->assertContains('/store/delivery-options/{deliveryOption}', $paths);
        $this->assertContains('/store/faqs', $paths);
        $this->assertContains('/store/faqs/{faq}', $paths);
        $this->assertContains('/store/gallery-images', $paths);
        $this->assertContains('/store/gallery-images/{galleryImage}', $paths);
        $this->assertContains('/store/time-slots', $paths);
        $this->assertContains('/store/time-slots/{timeSlot}', $paths);
        $this->assertContains('/store/products', $paths);
        $this->assertContains('/store/products/{product}', $paths);
        $this->assertContains('/store/product-images', $paths);
        $this->assertContains('/store/product-images/{productImage}', $paths);
        $this->assertContains('/store/product-variants', $paths);
        $this->assertContains('/store/product-variants/{productVariant}', $paths);
        $this->assertContains('/store/riders', $paths);
        $this->assertContains('/store/riders/{rider}', $paths);
        $this->assertContains('/store/notifications', $paths);
        $this->assertContains('/store/notifications/{notification}', $paths);
        $this->assertContains('/store/orders', $paths);
        $this->assertContains('/store/orders/{order}', $paths);
        $this->assertContains('/store/orders/{order}/decision', $paths);
        $this->assertContains('/store/orders/{order}/rider', $paths);
        $this->assertContains('/store/orders/{order}/complete', $paths);
        $this->assertContains('/store/subscription-orders', $paths);
        $this->assertContains('/store/subscription-orders/{subscriptionOrder}', $paths);
        $this->assertContains('/store/subscription-orders/{subscriptionOrder}/decision', $paths);
        $this->assertContains('/store/subscription-orders/{subscriptionOrder}/rider', $paths);
