...
class ArchitectureLayeringTest extends TestCase
{
    ...
    public function test_current_persistence_workflows_have_repositories(): void
    {
        ...
        $this->assertFileExists(app_path('Repositories/CustomerAddressRepository.php'));
        $this->assertFileExists(app_path('Repositories/CustomerNotificationRepository.php'));
        $this->assertFileExists(app_path('Repositories/CustomerRepository.php'));
        $this->assertFileExists(app_path('Repositories/StoreRepository.php'));
        ...
        $this->assertFileExists(app_path('Repositories/StoreNotificationRepository.php'));
        $this->assertFileExists(app_path('Repositories/DeliveryOptionRepository.php'));
        $this->assertFileExists(app_path('Repositories/FavoriteRepository.php'));
        ...
        $this->assertFileExists(app_path('Repositories/PaymentMethodRepository.php'));
        $this->assertFileExists(app_path('Repositories/ZoneRepository.php'));
        $this->assertFileExists(app_path('Repositories/RiderRepository.php'));
        $this->assertFileExists(app_path('Repositories/WalletTransactionRepository.php'));
        $this->assertFileExists(app_path('Repositories/PayoutRequestRepository.php'));
        $this->assertFileExists(app_path('Repositories/CashCollectionRepository.php'));
        $this->assertFileExists(app_path('Repositories/SettingRepository.php'));
        $this->assertFileExists(app_path('Repositories/MilkDataRepository.php'));
        $this->assertFileExists(app_path('Repositories/OrderRepository.php'));
        $this->assertFileExists(app_path('Repositories/OrderItemRepository.php'));
        $this->assertFileExists(app_path('Repositories/SubscriptionOrderRepository.php'));
        $this->assertFileExists(app_path('Repositories/SubscriptionOrderItemRepository.php'));
    }
}
