...
class LegacySchemaCoverageTest extends TestCase
{
    ...
    public function test_catalog_and_content_tables_cover_legacy_columns(): void
    {
        ...
        $this->assertTableHasColumns('products', ['store_id', 'store_category_id', 'title', 'image_path', 'description', 'is_active']);
        ...
        $this->assertTableHasColumns('time_slots', ['store_id', 'starts_at', 'ends_at', 'is_active']);
        $this->assertTableHasColumns('coupons', ['store_id', 'image_path', 'title', 'code', 'subtitle', 'expires_at', 'minimum_amount', 'value', 'description', 'is_active']);
        $this->assertTableHasColumns('faqs', ['store_id', 'question', 'answer', 'is_active']);
        $this->assertTableHasColumns('pages', ['title', 'description', 'is_active']);
    ...
    public function test_order_subscription_and_finance_tables_cover_legacy_columns(): void
    {
        ...
        $this->assertTableHasColumns('customer_addresses', ['customer_id', 'address', 'landmark', 'rider_instruction', 'type', 'latitude', 'longitude']);
        $this->assertTableHasColumns('favorites', ['customer_id', 'store_id', 'zone_id']);
