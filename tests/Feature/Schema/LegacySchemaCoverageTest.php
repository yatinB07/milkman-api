...
class LegacySchemaCoverageTest extends TestCase
{
    ...
    public function test_order_subscription_and_finance_tables_cover_legacy_columns(): void
    {
        ...
        $this->assertTableHasColumns('subscription_orders', [...$orderColumns, 'deleted_at']);
        $this->assertTableHasColumns('order_items', ['order_id', 'quantity', 'product_title', 'discount', 'image_path', 'price', 'variant_title', 'deleted_at']);
        $this->assertTableHasColumns('subscription_order_items', ['subscription_order_id', 'quantity', 'product_title', 'discount', 'image_path', 'price', 'variant_title', 'starts_at', 'total_deliveries', 'total_dates', 'completed_dates', 'selected_days', 'time_slot', 'deleted_at']);
        ...
        $this->assertTableHasColumns('payout_requests', ['store_id', 'amount', 'status', 'proof_path', 'requested_at', 'request_type', 'account_number', 'bank_name', 'account_name', 'ifsc_code', 'upi_id', 'paypal_id', 'deleted_at']);
        $this->assertTableHasColumns('cash_collections', ['store_id', 'amount', 'message', 'collected_at', 'deleted_at']);
